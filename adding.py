...
from telethon.errors.rpcerrorlist import PeerFloodError, UserPrivacyRestrictedError, FloodWaitError, UserChannelsTooMuchError, ChatWriteForbiddenError, UserIdInvalidError, UsernameNotOccupiedError, ChatAdminRequiredError, UserDeactivatedBanError
...
print('\n')
mode = int(input("1. add dengan UserId\n2. add dengan Username\nPilih mode : "))
...
def add_username():
  ...
  for x,user in users.iterrows():
    ...
    try:
        ...
        print(Fore.RED + "akun anda di banned / di blokir")
        print(Fore.WHITE + "akun anda di banned / di blokir")
        client.disconnect()
        sys.exit()
    except ChatAdminRequiredError:
        print(Fore.RED + "Anda tidak punya izin untuk menambahkan bot ke dalam grup\nSkip ...")
        time.sleep(2)
        continue
    except:
